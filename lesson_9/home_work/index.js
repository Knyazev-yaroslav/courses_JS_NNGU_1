...
// Сделай таймер, который раз в секунду тикает
// Тебе надо сделать чтобы у тебя и таймер
// в консоли отображался и цикл исполнялся

// Если сделать простой вызов цикла у тебя все
// зависнет, поэтому его надо сделать асинхронным
